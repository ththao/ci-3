<div id="m-content" class="m-workorder m-create-wo">
	<form class="create-wo-form">
        <div class="add-wo-header">
            <a class="back-to-home" href="/mobile/workorder"><i class="fa fa-arrow-left"></i> Back</a>
            Work Orders
            <a class="save-new-wo" mobile="1" href="#"><i class="fa fa-save"></i> Save</a>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="equipment-search">
                    <input type="text" class="equipment-search-text" />
