        ...
        <div class="col-xs-12 col-sm-8 col-md-9 col-lg-10 content new-layout">
            <div id="m-content" class="m-workorder">
                <div class="m-title d-title">
                    <h1 class="m-title-head d-title-head">Work Orders</h1>
                </div>
                <div class="m-wo-list">
                    <?php if ($add_wo_permission) { ?>
                    <div class="emp-add-wo-area">
                        <a class="add-wo" href="workorder/create">Create Work Order</a>
                    </div>
                    <?php } ?>
                    <?php if ($work_orders): ?>
                                ...
                                <div class="wo-item-header">
                                    ...
                                    <div class="wo-header-info">
                                        ...
                                        <div class="wo-header-action">
                                            <a class="wo-header-btn update-hour equipment-update" mobile="0" href="#" equipment_id="<?php echo $wo['equipment_id']; ?>"><i class="far fa-clock"></i> Hours</a>
                                    ...
                                    <div class="wo-job-list">
                                        ...
                                        <?php if ($jobs): ?>
                                            ...
                                            <div class="wo-job-item add-job-field">
                                                <a href="#" class="add-new-wo-job wo-main-btn" wo_item_id="<?php echo $wo['id']; ?>"><i class="fa fa-plus"></i> Add Job</a>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
