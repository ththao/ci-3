<div id="main" class="container-fluid main-content pad0">
    <div class="row mar0">
        ...
        <div class="col-xs-12 col-sm-8 col-md-9 col-lg-10 content new-layout">
            <div id="m-content" class="m-workorder d-workorder-detail">

            <?php if ($work_order) { ?>
                <div class="m-wo-header">
                    <div class="m-wo-title"><a class="back-work-order" href="/workorder"><i class="fa fa-arrow-left"></i></a><?php echo $work_order['name']; ?></div>
                </div>
                <div class="m-wo-detail">
                    <div class="wo-detail-equipment">
                        ...
                        <div class="equipment-action">
                            <a class="equipment-update" mobile="0" href="#" equipment_id="<?php echo $work_order['equipment_id']; ?>">Update</a>
