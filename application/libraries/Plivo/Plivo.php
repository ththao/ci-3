<?php
ini_set("include_path", '/home/advan215/php:' . ini_get("include_path"));
...
class Plivo
{
    ...
    function __construct()
    {
        ...
        $this->powerpack_uuid = POWERPACKUUID;
    }
    ...
    private function request($method, $path, $params = array())
    {
        ...
        if (! strcmp($method, "POST")) {
            ...
            if ($params) {
                if (isset($params['powerpack'])) {
                    if ($params['powerpack']) {
                        $params['powerpack_uuid'] = $this->powerpack_uuid;
                        unset($params['src']);
                    }
                    unset($params['powerpack']);
                }
